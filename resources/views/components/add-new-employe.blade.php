<form action="/employe-add" method="POST" id="form">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">                                    
                            <input type="text" class="form-control" name="e_role" placeholder="Role">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <label class="fancy-radio custom-color-green"><input name="gender3" value="M" type="radio" checked><span><i></i>Male</span></label>
                        <label class="fancy-radio custom-color-green"><input name="gender3" value="F" type="radio"><span><i></i>Female</span></label>
