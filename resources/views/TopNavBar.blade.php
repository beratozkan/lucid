<nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            <a href="index"><img src="../assets/images/logo.svg" alt="Lucid Logo" class="img-responsive logo"></a>                
        </div>
        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">                        
                    ...
                    <li><a href="app-chat" class="icon-menu d-none d-sm-block"><i class="icon-bubbles"></i></a></li>
